...
for the code generated by TatSu from the "lilypond.ebnf" file, and not for the code that translates
the TatSu-parsed data into Lychee-MEI. (Yes, of course, what we actually need to test is the grammar,
not the generated code, but we can't very well do that, can we?)
"""

from __future__ import unicode_literals

from tatsu.exceptions import FailedLookahead, FailedParse
import pytest
