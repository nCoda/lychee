...
def do_document(l_document, user_settings):
    ...
    for l_top_level_element in l_document:
        if isinstance(l_top_level_element, dict):
...
def do_score(l_score, context=None):
    ...
    :param dict l_score: The LilyPond score as parsed by TatSu.
...
def set_clef(l_clef, m_staffdef, context=None, action=None):
    ...
    :param dict l_time: The clef as parsed by TatSu.
...
def set_time(l_time, m_staffdef, context=None):
    ...
    :param dict l_time: The time specification as parsed by TatSu.
...
def set_key(l_key, m_staffdef, context=None):
    ...
    :param dict l_key: The key specification as parsed by TatSu.
...
def set_instrument_name(l_name, m_staffdef, context=None):
    ...
    :param dict l_name: The instrument name as parsed by TatSu.
...
def do_staff(l_staff, m_section, m_staffdef, context=None, action=None):
    '''
    :param dict l_staff: The LilyPond Staff context from TatSu.
...
def do_layer(l_layer, m_staff, layer_n, m_staffdef=None, context=None, action=None):
    ...
    :param l_layer: The LilyPond Voice context from TatSu.
...
def process_pitch(l_note, note_attrib, accid_attrib, context=None):
    ...
    :param l_note: The LilyPond note as provided by TatSu. This function reads the keys 'pitch_name'
    and 'accid_force'.
    :type l_note: dict
...
def process_octave(l_oct, action):
    ...
    :param str l_oct: The "octave" part of the LilyPond note as provided by TatSu. May also be ``None``.
...
def process_dots(l_node, attrib, action):
    ...
    :param dict l_node: The LilyPond node from TatSu.
...
def do_chord(l_chord, m_layer, context=None, action=None):
    ...
    :param dict l_chord: The LilyPond chord from TatSu.
    :param m_layer: The MEI <layer> that will hold the chord.
    :type m_layer: :class:`lxml.etree.Element`
    :returns: The new <chord/> element.
    :rtype: :class:`lxml.etree.Element`
    :raises: :exc:`exceptions.LilyPondError` if ``l_chord`` does not contain a TatSu chord
    """
...
def do_note(l_note, m_parent, context=None, action=None):
    ...
    :param dict l_note: The LilyPond note from TatSu.
    ...
    :rtype: :class:`lxml.etree.Element`
    :raises: :exc:`exceptions.LilyPondError` if ``l_note`` does not contain a TatSu note
    """
...
def do_rest(l_rest, m_layer, context=None, action=None):
    ...
    :param dict l_rest: The LilyPond rest from TatSu.
    :param m_layer: The LMEI <layer> that will hold the rest.
    :type m_layer: :class:`lxml.etree.Element`
    :returns: The new <rest/> element.
    :rtype: :class:`lxml.etree.Element`
    :raises: :exc:`exceptions.LilyPondError` if ``l_rest`` does not contain a TatSu rest
    """
...
def do_spacer(l_spacer, m_layer, context=None, action=None):
    ...
    :param dict l_spacer: The LilyPond spacer rest from TatSu.
    :param m_layer: The LMEI <layer> that will hold the space.
    :type m_layer: :class:`lxml.etree.Element`
    :returns: The new <space/> element.
    :rtype: :class:`lxml.etree.Element`
    :raises: :exc:`exceptions.LilyPondError` if ``l_spacer`` does not contain a TatSu spacer rest
    """
