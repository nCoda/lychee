...
from lychee.converters.inbound import abjad as abjad_to_lmei
...
class TestStaffToStaff(abjad_test_case.AbjadTestCase):
    ...
    @pytest.mark.xfail(True, reason='Staff must have Measures through 1605')
    @mock.patch("lychee.converters.inbound.abjad.voice_to_layer")
...
class TestAbjadToLmeiConversions(abjad_test_case.AbjadTestCase):
    ...
    @mock.patch("lychee.converters.inbound.abjad.tuplet_to_tupletspan")
    @mock.patch("lychee.converters.inbound.abjad.leaf_to_element")
    @mock.patch("lychee.converters.inbound.abjad.add_xml_ids")
    ...
    @mock.patch("lychee.converters.inbound.abjad.staff_to_staff")
    ...
    #     postcondition: list containing mei tupletspan Element with dur attr
    #     '''
    #     abjad_tuplet = Tuplet(Duration(3,8), [])
    ...
    #     '''
    #     inner_tuplet = Tuplet((1,4), "c'8 c' c'")
    #     outer_tuplet = Tuplet((3,8), [])
